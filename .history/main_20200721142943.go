...
I start learn golang and I discovered golang structure , types and functions and I'm no need to take a
 look about go template?
 Can you please send me a useful link to quick start .", "Thanks,best regards"}
  return message
}
